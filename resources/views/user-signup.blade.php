    ...
    <div class="card signup-card p-4 shadow-lg border-0 rounded-4" style="width: 420px;">
        ...
        <form action="/user-signup" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="username" class="form-control input-custom" value="{{old('username')}}" placeholder="Enter Your Name">
                @error('username')
            ...
            <button class="btn signup-btn w-100">Sign Up</button>
        </form>
    </div>
</div>
