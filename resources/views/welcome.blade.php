...
<body>
    ...
    <div class="container mt-5 pt-5 text-center">
        ...
        @endif
        <h1 class="page-title">Check Your Skills</h1>
    </div>
    <form action="/search-quiz" method="get">
        <div class="d-flex justify-content-center mt-4">
            <div class="position-relative w-50 search-group">
                <input type="text" name="search" class="form-control search-input ps-4 pe-5"
                    placeholder="Search Quiz Here...">
                <button type="submit"
                    class="search-icon position-absolute top-50 end-0 translate-middle-y me-2 border-0 d-flex align-items-center justify-content-center">
    ...
    <div class="main-content">
        <div class="text-center my-4">
            <h2 class="sub-page-title">Top Categories</h2>
        </div>
            ...
            <tbody>
                @foreach($categories as $key => $category)
                    <tr>
                        ...
                        <td>
                            <a href="user-quiz-list/{{$category->id}}/{{str_replace(' ','-',$category->category)}}" class="action-btn">
    ...
    <div class="main-content">
        <div class="text-center my-4">
            <h2 class="sub-page-title mt-5">Top Quiz</h2>
        </div>
        <table class="table w-75 mx-auto text-center shadow-sm rounded-4">
